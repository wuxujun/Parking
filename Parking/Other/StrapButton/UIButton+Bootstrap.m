...
-(void)blueStyle{
    ...
    self.backgroundColor = DEFAULT_NAVIGATION_BACKGROUND_COLOR;
    self.layer.borderColor = [DEFAULT_NAVIGATION_BACKGROUND_COLOR CGColor];
    [self setBackgroundImage:[self buttonImageFromColor:DEFAULT_NAVIGATION_BACKGROUND_COLOR] forState:UIControlStateHighlighted];
}
